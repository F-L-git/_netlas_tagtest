...
# Указать начальный тег
start_tag = 'litespeed'

# Пропустить все теги до указанного начального тега
start_index = tags.index(start_tag) if start_tag in tags else 0
...
for index, tag in enumerate(tags[start_index:], start=start_index+1):
